...
int main() {
    ...
    // entspricht also dem Index des Elementes, das eine 1 enth�lt
    int posX=0;
	char zug;
	...
	do {
		// Array �ber Funktionsaufruf printArray(int *, int *); ausgeben
        ...
        // Zug ausf�hren mit Funktionsaufruf move(int *, int *, char *, int *);
